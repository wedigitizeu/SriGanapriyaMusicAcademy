...
//include_once('visitor-count.php');
...
<html lang="en">
  <head>
    ...
    <meta property="og:site_name" content="Sangam Florist Mathikere">
	...
	<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-eye fa-3x"></i>
            <div class="info">
              <h4 title="Today's Visitors">Today</h4>
              <p><b><?php if(isset($x)){ echo $x; } ?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-eye fa-3x"></i>
            <div class="info">
              <h4 title="Total Visitors">Total</h4>
              <p><b><?php  if(isset($y)){ echo $y; }  ?></b> </p>
            </div>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-meetup fa-3x"></i>
            <div class="info">
              <h4>Meetings</h4>
              <p><b><?php echo $i; ?></b></p>
            </div>
